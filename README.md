...
Workshop materials for scenario planning and strategic foresight exercises

## Overview

This repository provides resources and tools for scenario planning workshop.
...
3. Apply frameworks to your scenario planning workshop projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores scenario planning workshop concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
